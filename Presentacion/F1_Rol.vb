...
#Region "METODOS SOBRECARGADOS"
    ...
    Public Overrides Function _PMOGetListEstructuraBuscador() As List(Of Modelos.Celda)
        ...
        listEstCeldas.Add(New Modelos.Celda("ybnumi", True, "ID", 70))
        listEstCeldas.Add(New Modelos.Celda("ybrol", True, "ROL", 120))
        listEstCeldas.Add(New Modelos.Celda("ybfact", False))
        listEstCeldas.Add(New Modelos.Celda("ybhact", False))
        listEstCeldas.Add(New Modelos.Celda("ybuact", False))
