...
Public Class R_Ejemploborrar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_Ejemplo(borrar).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_Ejemploborrar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_Ejemploborrar = New R_Ejemploborrar()
        rpt.Site = Me.Site
        Return rpt
    End Function
