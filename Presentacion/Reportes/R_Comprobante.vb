...
Public Class R_Comprobante
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_Comprobante.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_Comprobante
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_Comprobante = New R_Comprobante()
        rpt.Site = Me.Site
        Return rpt
    End Function
