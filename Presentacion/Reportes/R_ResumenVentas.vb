...
Public Class R_ResumenVentas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ResumenVentas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ResumenVentas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ResumenVentas = New R_ResumenVentas()
        rpt.Site = Me.Site
        Return rpt
    End Function
