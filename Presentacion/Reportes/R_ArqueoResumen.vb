...
Public Class R_ArqueoResumen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ArqueoResumen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ArqueoResumen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ArqueoResumen = New R_ArqueoResumen()
        rpt.Site = Me.Site
        Return rpt
    End Function
