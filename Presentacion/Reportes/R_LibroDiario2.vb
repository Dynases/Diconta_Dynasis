...
Public Class R_LibroDiario2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_LibroDiario2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_LibroDiario2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_LibroDiario2 = New R_LibroDiario2()
        rpt.Site = Me.Site
        Return rpt
    End Function
