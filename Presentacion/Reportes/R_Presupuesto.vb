...
Public Class R_Presupuesto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_Presupuesto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_Presupuesto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_Presupuesto = New R_Presupuesto()
        rpt.Site = Me.Site
        Return rpt
    End Function
