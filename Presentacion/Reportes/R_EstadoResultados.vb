...
Public Class R_EstadoResultados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_EstadoResultados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_EstadoResultados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_EstadoResultados = New R_EstadoResultados()
        rpt.Site = Me.Site
        Return rpt
    End Function
