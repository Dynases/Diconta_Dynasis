...
Public Class R_ComprobanteIntegracion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R_ComprobanteIntegracion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_ComprobanteIntegracion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_titulo2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR_ComprobanteIntegracion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ComprobanteIntegracion = New R_ComprobanteIntegracion()
        rpt.Site = Me.Site
        Return rpt
    End Function
