...
Public Class R_BalanceGeneral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_BalanceGeneral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_BalanceGeneral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_BalanceGeneral = New R_BalanceGeneral()
        rpt.Site = Me.Site
        Return rpt
    End Function
