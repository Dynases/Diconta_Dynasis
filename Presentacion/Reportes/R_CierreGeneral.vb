...
Public Class R_CierreGeneral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_CierreGeneral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_CierreGeneral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_CierreGeneral = New R_CierreGeneral()
        rpt.Site = Me.Site
        Return rpt
    End Function
