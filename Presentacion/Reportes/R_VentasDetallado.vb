...
Public Class R_VentasDetallado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentacion.R_VentasDetallado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_VentasDetallado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_VentasDetallado = New R_VentasDetallado()
        rpt.Site = Me.Site
        Return rpt
    End Function
