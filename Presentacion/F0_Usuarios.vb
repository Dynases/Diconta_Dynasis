...
#Region " Grabar-Button "
    ...
    Private Sub _PGrabarRegistro()
        ...
        If P_Validar() Then
            ...
            If _Nuevo Then
                L_Usuario_Grabar(Tb_Id.Text, Tb_Nombre.Text, TextBoxX1.Text, JMC_Categoria.Value, Tb_Estado.Value, Tb_DiasPedidos.Value, Tb_fuenteTam.Value, cbSucursal.Value, IIf(tbTodasSucursales.Value = True, "1", "0"), 1)
                ...
                _PLimpiar()
            Else
                L_Usuario_Modificar(Tb_Id.Text, Tb_Nombre.Text, TextBoxX1.Text, JMC_Categoria.Value, Tb_Estado.Value, Tb_DiasPedidos.Value, Tb_fuenteTam.Value, cbSucursal.Value, IIf(tbTodasSucursales.Value = True, "1", "0"), 1)
