...
Public Class PR_EstadoCuentasActivoPasivo
    ...
    Private Sub _prIniciarTodo()
        _PMIniciarTodo()
        Me.Text = "reporte estado de cuentas activo y pasivo".ToUpper
    ...
    Private Sub _prCargarReporte()
        ...
        If tbFiltrar.Value = True Or tbFiltrarSucursal.Value = True Then
            ...
            If tbFiltrarSucursal.Value = True Then
                ...
                End If
            End If
            dt = L_prCuentaReporteEstadoCuentasActivoPasivoPorAuxiliar(gi_empresaNumi, tbFechaDel.Value.ToString("yyyy/MM/dd"), tbFechaAl.Value.ToString("yyyy/MM/dd"), numiModulo, numiSuc)

            'If tbVariable.SelectedIndex >= 0 Then
            '    dt = L_prCuentaReporteEstadoCuentasActivoPasivoPorAuxiliar(gi_empresaNumi, tbFechaDel.Value.ToString("yyyy/MM/dd"), tbFechaAl.Value.ToString("yyyy/MM/dd"), tbVariable.Value)

            'Else
            '    ToastNotification.Show(Me, "debe seleccionar un auxiliar y variable..!!!",
            '                           My.Resources.WARNING, 2000,
            '                           eToastGlowColor.Blue,
            '                           eToastPosition.BottomLeft)
            '    Return
            'End If
        Else
            dt = L_prCuentaReporteEstadoCuentasActivoPasivo(gi_empresaNumi, tbFechaDel.Value.ToString("yyyy/MM/dd"), tbFechaAl.Value.ToString("yyyy/MM/dd"))

        End If
        If (dt.Rows.Count > 0) Then

            Dim objrep As New R_EstadoCuentasActivoPasivo
