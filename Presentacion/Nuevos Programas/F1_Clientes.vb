...
#Region "Metodos Privados"
    ...
    Private Sub _prIniciarTodo()
        ...
        _prCargarComboLibreria(cbTipoDoc, 12, 1)
        _prAsignarPermisos()
        _PMIniciarTodo()
...
#Region "METODOS SOBRECARGADOS"
    ...
    Public Overrides Function _PMOGrabarRegistro() As Boolean
        ...
        Dim res As Boolean = L_fnGrabarCLiente(tbCodigoOriginal.Text, tbCodCliente.Text, tbRazonSocial.Text, tbNombre.Text, NumiVendedor, 1, cbTipoDoc.Value, tbNdoc.Text, tbDireccion.Text, tbTelf1.Text, tbTelf2.Text, 1, IIf(swEstado.Value = True, 1, 0), _latitud, _longitud, tbObs.Text, tbFnac.Value.ToString("yyyy/MM/dd"), tbNombFac.Text, _Tipo, tbNit.Text, tbFIngr.Value.ToString("yyyy/MM/dd"), tbUltVenta.Value.ToString("yyyy/MM/dd"), nameImg, 1)
    ...
    Public Overrides Function _PMOModificarRegistro() As Boolean
        ...
        If (Modificado = False) Then
            res = L_fnModificarClientes(tbCodigoOriginal.Text, tbCodCliente.Text, tbRazonSocial.Text, tbNombre.Text, NumiVendedor, 1, cbTipoDoc.Value, tbNdoc.Text, tbDireccion.Text, tbTelf1.Text, tbTelf2.Text, 1, IIf(swEstado.Value = True, 1, 0), _latitud, _longitud, tbObs.Text, tbFnac.Value.ToString("yyyy/MM/dd"), tbNombFac.Text, _Tipo, tbNit.Text, tbFIngr.Value.ToString("yyyy/MM/dd"), tbUltVenta.Value.ToString("yyyy/MM/dd"), nameImage, 1)
    ...
    Public Overrides Function _PMOGetListEstructuraBuscador() As List(Of Modelos.Celda)
        ...
        listEstCeldas.Add(New Modelos.Celda("ydnumi", False, "Código", 80))
        listEstCeldas.Add(New Modelos.Celda("ydcod", True, "Codigo".ToUpper, 80))
        listEstCeldas.Add(New Modelos.Celda("ydrazonsocial", True, "Razon Social".ToUpper, 180))
        listEstCeldas.Add(New Modelos.Celda("yddesc", True, "Nombres".ToUpper, 250))
        listEstCeldas.Add(New Modelos.Celda("ydzona", False))
        listEstCeldas.Add(New Modelos.Celda("yddct", False))
        listEstCeldas.Add(New Modelos.Celda("yddctnum", True, "N. Documento".ToUpper, 150))
        listEstCeldas.Add(New Modelos.Celda("yddirec", True, "Direccion".ToUpper, 180))
        listEstCeldas.Add(New Modelos.Celda("ydtelf1", False))
        listEstCeldas.Add(New Modelos.Celda("ydtelf2", False))
        listEstCeldas.Add(New Modelos.Celda("ydcat", False))
        listEstCeldas.Add(New Modelos.Celda("ydest", False))
        listEstCeldas.Add(New Modelos.Celda("ydlat", False))
        listEstCeldas.Add(New Modelos.Celda("ydlongi", False))
        listEstCeldas.Add(New Modelos.Celda("ydprconsu", False))
        listEstCeldas.Add(New Modelos.Celda("ydobs", True, "Observacion".ToUpper, 180))
        listEstCeldas.Add(New Modelos.Celda("ydfnac", True, "Fecha Nacimiento".ToUpper, 150))
        listEstCeldas.Add(New Modelos.Celda("ydnomfac", True, "Factura".ToUpper, 200))
        listEstCeldas.Add(New Modelos.Celda("ydtip", False))
        listEstCeldas.Add(New Modelos.Celda("ydnit", True, "Nit".ToUpper, 120))
        listEstCeldas.Add(New Modelos.Celda("ydfecing", False))
        listEstCeldas.Add(New Modelos.Celda("ydultvent", False))
        listEstCeldas.Add(New Modelos.Celda("ydimg", False))
        listEstCeldas.Add(New Modelos.Celda("ydfact", False))
        listEstCeldas.Add(New Modelos.Celda("ydhact", False))
        listEstCeldas.Add(New Modelos.Celda("yduact", False))
        listEstCeldas.Add(New Modelos.Celda("ydrut", False))
        listEstCeldas.Add(New Modelos.Celda("visita", False, "FRECUENCIA DE VISITA", 120))
        listEstCeldas.Add(New Modelos.Celda("zona", False, "ZONA".ToUpper, 150))
        listEstCeldas.Add(New Modelos.Celda("documento".ToUpper, True, "Tipo Documento".ToUpper, 150))
        listEstCeldas.Add(New Modelos.Celda("ydnumivend", False))
        listEstCeldas.Add(New Modelos.Celda("vendedor", False))
        listEstCeldas.Add(New Modelos.Celda("yddias", False))
        listEstCeldas.Add(New Modelos.Celda("ydlcred", False))
